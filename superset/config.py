...
#     "rel": "icon"
# },
FAVICONS = [{"href": "https://www.huifu.com/public/huifu-site/img/favicon.ico"}]
...
APP_ICON = "/static/assets/images/datacube-logo.png"
APP_ICON_WIDTH = 126
...
# 加载自定义配置
try:
    from superset.customize_config import *
except Exception as e:
    print(f"customize_config load error!!! {e}")
    logger = logging.getLogger(__name__)
    logger.info("customize_config load error!!!")
